...
{
	public partial class TipoEventoCtrl : System.Web.UI.UserControl
	{
		...
		{
			List<BOTipoEvento> boTipoEventos = new List<BOTipoEvento>() { new BOTipoEvento() };
			gridView1.DataSource = boTipoEventos;
			gridView1.DataBind();
		...
		{
			BOTipoEvento searchBO = new BOTipoEvento();
			try
			{
			...
			try
			{
				List<BOTipoEvento> boTipoEventos = null;
				int resultCount = BOTipoEvento.TipoEventoCollectionFromSearchFieldsCount(searchBO);
				...
				boTipoEventos = BOTipoEvento.TipoEventoCollectionFromSearchFields(searchBO);
				if(boTipoEventos.Count == 0)
				{ BindEmptyRow(); return 0; }
				
				Session["_boTipoEventos"] = boTipoEventos;
				gridView1.DataSource = boTipoEventos;
				gridView1.DataBind();
				return boTipoEventos.Count;
			}
			catch(Exception ex)
		...
		protected void gridView1_RowEditing(object sender, GridViewEditEventArgs e)
		{
			...
			List<BOTipoEvento> boTipoEventos = (List<BOTipoEvento>)Session["_boTipoEventos"];
			gridView1.DataSource = boTipoEventos;
			gridView1.DataBind();
		}
		...
		{
			List<BOTipoEvento> _boTipoEventos = (List<BOTipoEvento>)Session["_boTipoEventos"];
			BOTipoEvento boTipoEvento = _boTipoEventos[e.RowIndex];
			try
			{
				TextBox txtbxNombre = (TextBox)gridView1.Rows[e.RowIndex].FindControl("NombreGridTxtBx");
				boTipoEvento.Nombre = string.IsNullOrEmpty(txtbxNombre.Text) ? null : txtbxNombre.Text;
			}
			catch(Exception ex)
		...
		{
			List<BOTipoEvento> _boTipoEventos = (List<BOTipoEvento>)Session["_boTipoEventos"];
			BOTipoEvento boTipoEvento = _boTipoEventos[(gridView1.PageIndex*gridView1.PageSize)+e.RowIndex];
		
			try{ boTipoEvento.Delete(); }
			catch(Exception ex)
		...
		protected void gridView1_RowCommand(object sender, GridViewCommandEventArgs e)
		{
			...
			{
				BOTipoEvento boTipoEvento = new BOTipoEvento();
				try
				{
					TextBox txtbxNombre = (TextBox)gridView1.FooterRow.FindControl("NombreGridNewTxtBx");
					if(!string.IsNullOrEmpty(txtbxNombre.Text)) boTipoEvento.Nombre = txtbxNombre.Text;
				}
				catch(Exception ex)
