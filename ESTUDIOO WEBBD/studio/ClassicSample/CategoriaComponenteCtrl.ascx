<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CategoriaComponenteCtrl.ascx.cs" Inherits="studio.ClassicSample.CategoriaComponenteCtrl" %>
