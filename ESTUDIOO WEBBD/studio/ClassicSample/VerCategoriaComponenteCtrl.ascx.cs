...
{
	public partial class VerCategoriaComponenteCtrl : System.Web.UI.UserControl
	{
		...
		{
			BOVerCategoriaComponente searchBO = new BOVerCategoriaComponente();
			try
			{
			...
			try
			{
				List<BOVerCategoriaComponente> boVerCategoriaComponentes = null;
				int resultCount = BOVerCategoriaComponente.VerCategoriaComponenteCollectionFromSearchFieldsCount(searchBO);
				...
				boVerCategoriaComponentes = BOVerCategoriaComponente.VerCategoriaComponenteCollectionFromSearchFields(searchBO);
				Session["_boVerCategoriaComponentes"] = boVerCategoriaComponentes;
				gridView1.DataSource = boVerCategoriaComponentes;
				gridView1.DataBind();
				return boVerCategoriaComponentes.Count;
			}
			catch(Exception ex)
