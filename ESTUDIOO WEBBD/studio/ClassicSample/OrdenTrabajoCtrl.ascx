<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OrdenTrabajoCtrl.ascx.cs" Inherits="studio.ClassicSample.OrdenTrabajoCtrl" %>
	...
	<tr style="height: 500px">
		<td valign="top" style="background: lightblue;" width="70%">
			<asp:GridView ID="gridView1" runat="server" Width="100%" AutoGenerateColumns="False" ShowFooter="true" AllowPaging="True" PageSize="15" BorderStyle="None">
				<Columns>
					...
					<asp:TemplateField HeaderText="FechaO" >
						<HeaderStyle BackColor="#4b6c9e" ForeColor="White" Height="30" Font-Size="X-Small"/>
						<ItemTemplate>
							<asp:Label runat="server" ID="FechaOGridLbl" Text='<%# Bind("FechaO") %>'  Font-Size="X-Small" ForeColor="Black"></asp:Label>
						</ItemTemplate>
						<ItemStyle BackColor="White" Height="26px"></ItemStyle>
						<FooterStyle BackColor="White" Height="26px" />
						<EditItemTemplate>
							<asp:TextBox runat="server" ID="FechaOGridTxtBx" BackColor="White" ForeColor="Green" Text='<%# Bind("FechaO") %>' Width="98%" BorderStyle="None"  Font-Size="X-Small"></asp:TextBox>
						</EditItemTemplate>
						<FooterStyle BackColor="White" Height="26px" />
						<FooterTemplate>
							<asp:TextBox runat="server" ID="FechaOGridNewTxtBx" BackColor="White" ForeColor="Green" Text='<%# Bind("FechaO") %>' Width="98%" BorderStyle="None"  Font-Size="X-Small"></asp:TextBox>
						</FooterTemplate>
					</asp:TemplateField>
					<asp:TemplateField HeaderText="FechaE" >
						<HeaderStyle BackColor="#4b6c9e" ForeColor="White" Height="30" Font-Size="X-Small"/>
						<ItemTemplate>
							<asp:Label runat="server" ID="FechaEGridLbl" Text='<%# Bind("FechaE") %>'  Font-Size="X-Small" ForeColor="Black"></asp:Label>
						</ItemTemplate>
						<ItemStyle BackColor="White" Height="26px"></ItemStyle>
						<FooterStyle BackColor="White" Height="26px" />
						<EditItemTemplate>
							<asp:TextBox runat="server" ID="FechaEGridTxtBx" BackColor="White" ForeColor="Green" Text='<%# Bind("FechaE") %>' Width="98%" BorderStyle="None"  Font-Size="X-Small"></asp:TextBox>
						</EditItemTemplate>
						<FooterStyle BackColor="White" Height="26px" />
						<FooterTemplate>
							<asp:TextBox runat="server" ID="FechaEGridNewTxtBx" BackColor="White" ForeColor="Green" Text='<%# Bind("FechaE") %>' Width="98%" BorderStyle="None"  Font-Size="X-Small"></asp:TextBox>
						</FooterTemplate>
					</asp:TemplateField>
					...
					<asp:TemplateField HeaderText="Estado" >
						<HeaderStyle BackColor="#4b6c9e" ForeColor="White" Height="30" Font-Size="X-Small"/>
						<ItemTemplate>
							<asp:Label runat="server" ID="EstadoGridLbl" Text='<%# Bind("Estado") %>'  Font-Size="X-Small" ForeColor="Black"></asp:Label>
						</ItemTemplate>
						<ItemStyle BackColor="White" Height="26px"></ItemStyle>
						<FooterStyle BackColor="White" Height="26px" />
						<EditItemTemplate>
							<asp:TextBox runat="server" ID="EstadoGridTxtBx" BackColor="White" ForeColor="Green" Text='<%# Bind("Estado") %>' Width="98%" BorderStyle="None"  Font-Size="X-Small"></asp:TextBox>
						</EditItemTemplate>
						<FooterStyle BackColor="White" Height="26px" />
						<FooterTemplate>
							<asp:TextBox runat="server" ID="EstadoGridNewTxtBx" BackColor="White" ForeColor="Green" Text='<%# Bind("Estado") %>' Width="98%" BorderStyle="None"  Font-Size="X-Small"></asp:TextBox>
						</FooterTemplate>
					</asp:TemplateField>
					<asp:TemplateField HeaderText="Porcentaje" >
						<HeaderStyle BackColor="#4b6c9e" ForeColor="White" Height="30" Font-Size="X-Small"/>
						<ItemTemplate>
							<asp:Label runat="server" ID="PorcentajeGridLbl" Text='<%# Bind("Porcentaje") %>'  Font-Size="X-Small" ForeColor="Black"></asp:Label>
						</ItemTemplate>
						<ItemStyle BackColor="White" Height="26px"></ItemStyle>
						<FooterStyle BackColor="White" Height="26px" />
						<EditItemTemplate>
							<asp:TextBox runat="server" ID="PorcentajeGridTxtBx" BackColor="White" ForeColor="Green" Text='<%# Bind("Porcentaje") %>' Width="98%" BorderStyle="None"  Font-Size="X-Small"></asp:TextBox>
						</EditItemTemplate>
						<FooterStyle BackColor="White" Height="26px" />
						<FooterTemplate>
							<asp:TextBox runat="server" ID="PorcentajeGridNewTxtBx" BackColor="White" ForeColor="Green" Text='<%# Bind("Porcentaje") %>' Width="98%" BorderStyle="None"  Font-Size="X-Small"></asp:TextBox>
						</FooterTemplate>
					</asp:TemplateField>
		...
		<td style="width: 400px; background-color:lightgray" valign="top">
			<table style="width: 100%; padding-right:8px; padding-left:8px" >
				...
				<tr>
					<td style="width: 200px">
						<asp:Label runat="server" ID="FechaOSchLbl">FechaO</asp:Label>
					</td>
					<td style="width: 200px">
						<asp:TextBox runat="server" ID="FechaOSchTxtBx" Height="24" Width="98%" BorderStyle="None"></asp:TextBox>
					</td>
				</tr>
				<tr>
					<td style="width: 200px">
					...
					<td style="width: 200px">
						<asp:TextBox runat="server" ID="FechaESchTxtBx" Height="24" Width="98%" BorderStyle="None"></asp:TextBox>
					</td>
				</tr>
				<tr>
					<td style="width: 200px">
				...
				<tr>
					<td style="width: 200px">
						<asp:Label runat="server" ID="EstadoSchLbl">Estado</asp:Label>
					</td>
					<td style="width: 200px">
						<asp:TextBox runat="server" ID="EstadoSchTxtBx" Height="24" Width="98%" BorderStyle="None"></asp:TextBox>
					</td>
				</tr>
				<tr>
					<td style="width: 200px">
						<asp:Label runat="server" ID="PorcentajeSchLbl">Porcentaje</asp:Label>
					</td>
					<td style="width: 200px">
						<asp:TextBox runat="server" ID="PorcentajeSchTxtBx" Height="24" Width="98%" BorderStyle="None"></asp:TextBox>
					</td>
				</tr>
				<tr>
