<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PaqueteCtrl.ascx.cs" Inherits="studio.ClassicSample.PaqueteCtrl" %>
	...
	<tr style="height: 500px">
			...
			<asp:GridView ID="gridView1" runat="server" Width="100%" AutoGenerateColumns="False" ShowFooter="true" AllowPaging="True" PageSize="15" BorderStyle="None">
				<Columns>
					...
					<asp:TemplateField HeaderText="Descuento" >
						<HeaderStyle BackColor="#4b6c9e" ForeColor="White" Height="30" Font-Size="X-Small"/>
						<ItemTemplate>
							<asp:Label runat="server" ID="DescuentoGridLbl" Text='<%# Bind("Descuento") %>'  Font-Size="X-Small" ForeColor="Black"></asp:Label>
						</ItemTemplate>
						<ItemStyle BackColor="White" Height="26px"></ItemStyle>
						<FooterStyle BackColor="White" Height="26px" />
						<EditItemTemplate>
							<asp:TextBox runat="server" ID="DescuentoGridTxtBx" BackColor="White" ForeColor="Green" Text='<%# Bind("Descuento") %>' Width="98%" BorderStyle="None"  Font-Size="X-Small"></asp:TextBox>
						</EditItemTemplate>
						<FooterStyle BackColor="White" Height="26px" />
						<FooterTemplate>
							<asp:TextBox runat="server" ID="DescuentoGridNewTxtBx" BackColor="White" ForeColor="Green" Text='<%# Bind("Descuento") %>' Width="98%" BorderStyle="None"  Font-Size="X-Small"></asp:TextBox>
						</FooterTemplate>
					</asp:TemplateField>
					<asp:TemplateField HeaderText="PrecioTotal" >
						<HeaderStyle BackColor="#4b6c9e" ForeColor="White" Height="30" Font-Size="X-Small"/>
						<ItemTemplate>
							<asp:Label runat="server" ID="PrecioTotalGridLbl" Text='<%# Bind("PrecioTotal") %>'  Font-Size="X-Small" ForeColor="Black"></asp:Label>
						</ItemTemplate>
						<ItemStyle BackColor="White" Height="26px"></ItemStyle>
						<FooterStyle BackColor="White" Height="26px" />
						<EditItemTemplate>
							<asp:TextBox runat="server" ID="PrecioTotalGridTxtBx" BackColor="White" ForeColor="Green" Text='<%# Bind("PrecioTotal") %>' Width="98%" BorderStyle="None"  Font-Size="X-Small"></asp:TextBox>
						</EditItemTemplate>
						<FooterStyle BackColor="White" Height="26px" />
						<FooterTemplate>
							<asp:TextBox runat="server" ID="PrecioTotalGridNewTxtBx" BackColor="White" ForeColor="Green" Text='<%# Bind("PrecioTotal") %>' Width="98%" BorderStyle="None"  Font-Size="X-Small"></asp:TextBox>
						</FooterTemplate>
					</asp:TemplateField>
					<asp:TemplateField HeaderText="Generico" >
						<HeaderStyle BackColor="#4b6c9e" ForeColor="White" Height="30" Font-Size="X-Small"/>
						<ItemTemplate>
							<asp:Label runat="server" ID="GenericoGridLbl" Text='<%# Bind("Generico") %>'  Font-Size="X-Small" ForeColor="Black"></asp:Label>
						</ItemTemplate>
						<ItemStyle BackColor="White" Height="26px"></ItemStyle>
						<FooterStyle BackColor="White" Height="26px" />
						<EditItemTemplate>
							<asp:TextBox runat="server" ID="GenericoGridTxtBx" BackColor="White" ForeColor="Green" Text='<%# Bind("Generico") %>' Width="98%" BorderStyle="None"  Font-Size="X-Small"></asp:TextBox>
						</EditItemTemplate>
						<FooterStyle BackColor="White" Height="26px" />
						<FooterTemplate>
							<asp:TextBox runat="server" ID="GenericoGridNewTxtBx" BackColor="White" ForeColor="Green" Text='<%# Bind("Generico") %>' Width="98%" BorderStyle="None"  Font-Size="X-Small"></asp:TextBox>
						</FooterTemplate>
					</asp:TemplateField>
		...
		<td style="width: 400px; background-color:lightgray" valign="top">
			<table style="width: 100%; padding-right:8px; padding-left:8px" >
				...
				<tr>
					<td style="width: 200px">
						<asp:Label runat="server" ID="PrecioSchLbl">Precio</asp:Label>
					</td>
					<td style="width: 200px">
						<asp:TextBox runat="server" ID="PrecioSchTxtBx" Height="24" Width="98%" BorderStyle="None"></asp:TextBox>
					</td>
				</tr>
				<tr>
					<td style="width: 200px">
						<asp:Label runat="server" ID="DescuentoSchLbl">Descuento</asp:Label>
					</td>
					<td style="width: 200px">
						<asp:TextBox runat="server" ID="DescuentoSchTxtBx" Height="24" Width="98%" BorderStyle="None"></asp:TextBox>
					</td>
				</tr>
				<tr>
					<td style="width: 200px">
						<asp:Label runat="server" ID="PrecioTotalSchLbl">PrecioTotal</asp:Label>
					</td>
					<td style="width: 200px">
						<asp:TextBox runat="server" ID="PrecioTotalSchTxtBx" Height="24" Width="98%" BorderStyle="None"></asp:TextBox>
					</td>
				</tr>
				<tr>
					<td style="width: 200px">
						<asp:Label runat="server" ID="GenericoSchLbl">Generico</asp:Label>
					</td>
					<td style="width: 200px">
						<asp:TextBox runat="server" ID="GenericoSchTxtBx" Height="24" Width="98%" BorderStyle="None"></asp:TextBox>
					</td>
				</tr>
				<tr>
