<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ReservaCtrl.ascx.cs" Inherits="studio.ClassicSample.ReservaCtrl" %>
	...
	<tr style="height: 500px">
		<td valign="top" style="background: lightblue;" width="70%">
			<asp:GridView ID="gridView1" runat="server" Width="100%" AutoGenerateColumns="False" ShowFooter="true" AllowPaging="True" PageSize="15" BorderStyle="None">
				<Columns>
					...
					<asp:TemplateField HeaderText="FechaR" >
						<HeaderStyle BackColor="#4b6c9e" ForeColor="White" Height="30" Font-Size="X-Small"/>
						<ItemTemplate>
							<asp:Label runat="server" ID="FechaRGridLbl" Text='<%# Bind("FechaR") %>'  Font-Size="X-Small" ForeColor="Black"></asp:Label>
						</ItemTemplate>
						<ItemStyle BackColor="White" Height="26px"></ItemStyle>
						<FooterStyle BackColor="White" Height="26px" />
						<EditItemTemplate>
							<asp:TextBox runat="server" ID="FechaRGridTxtBx" BackColor="White" ForeColor="Green" Text='<%# Bind("FechaR") %>' Width="98%" BorderStyle="None"  Font-Size="X-Small"></asp:TextBox>
						</EditItemTemplate>
						<FooterStyle BackColor="White" Height="26px" />
						<FooterTemplate>
							<asp:TextBox runat="server" ID="FechaRGridNewTxtBx" BackColor="White" ForeColor="Green" Text='<%# Bind("FechaR") %>' Width="98%" BorderStyle="None"  Font-Size="X-Small"></asp:TextBox>
						</FooterTemplate>
					</asp:TemplateField>
					...
					<asp:TemplateField HeaderText="DiasEspera" >
						<HeaderStyle BackColor="#4b6c9e" ForeColor="White" Height="30" Font-Size="X-Small"/>
						<ItemTemplate>
							<asp:Label runat="server" ID="DiasEsperaGridLbl" Text='<%# Bind("DiasEspera") %>'  Font-Size="X-Small" ForeColor="Black"></asp:Label>
						</ItemTemplate>
						<ItemStyle BackColor="White" Height="26px"></ItemStyle>
						<FooterStyle BackColor="White" Height="26px" />
						<EditItemTemplate>
							<asp:TextBox runat="server" ID="DiasEsperaGridTxtBx" BackColor="White" ForeColor="Green" Text='<%# Bind("DiasEspera") %>' Width="98%" BorderStyle="None"  Font-Size="X-Small"></asp:TextBox>
						</EditItemTemplate>
						<FooterStyle BackColor="White" Height="26px" />
						<FooterTemplate>
							<asp:TextBox runat="server" ID="DiasEsperaGridNewTxtBx" BackColor="White" ForeColor="Green" Text='<%# Bind("DiasEspera") %>' Width="98%" BorderStyle="None"  Font-Size="X-Small"></asp:TextBox>
						</FooterTemplate>
					</asp:TemplateField>
					<asp:TemplateField HeaderText="Interasado" >
						<HeaderStyle BackColor="#4b6c9e" ForeColor="White" Height="30" Font-Size="X-Small"/>
						<ItemTemplate>
							<asp:Label runat="server" ID="InterasadoGridLbl" Text='<%# Bind("Interasado") %>'  Font-Size="X-Small" ForeColor="Black"></asp:Label>
						</ItemTemplate>
						<ItemStyle BackColor="White" Height="26px"></ItemStyle>
						<FooterStyle BackColor="White" Height="26px" />
						<EditItemTemplate>
							<asp:TextBox runat="server" ID="InterasadoGridTxtBx" BackColor="White" ForeColor="Green" Text='<%# Bind("Interasado") %>' Width="98%" BorderStyle="None"  Font-Size="X-Small"></asp:TextBox>
						</EditItemTemplate>
						<FooterStyle BackColor="White" Height="26px" />
						<FooterTemplate>
							<asp:TextBox runat="server" ID="InterasadoGridNewTxtBx" BackColor="White" ForeColor="Green" Text='<%# Bind("Interasado") %>' Width="98%" BorderStyle="None"  Font-Size="X-Small"></asp:TextBox>
						</FooterTemplate>
					</asp:TemplateField>
		...
		<td style="width: 400px; background-color:lightgray" valign="top">
			<table style="width: 100%; padding-right:8px; padding-left:8px" >
				...
				<tr>
					<td style="width: 200px">
						<asp:Label runat="server" ID="FechaRSchLbl">FechaR</asp:Label>
					</td>
					<td style="width: 200px">
						<asp:TextBox runat="server" ID="FechaRSchTxtBx" Height="24" Width="98%" BorderStyle="None"></asp:TextBox>
					</td>
				</tr>
				<tr>
					<td style="width: 200px">
				...
				<tr>
					...
					<td style="width: 200px">
						<asp:TextBox runat="server" ID="DiasEsperaSchTxtBx" Height="24" Width="98%" BorderStyle="None"></asp:TextBox>
					</td>
				</tr>
				<tr>
					<td style="width: 200px">
					...
					<td style="width: 200px">
						<asp:TextBox runat="server" ID="InterasadoSchTxtBx" Height="24" Width="98%" BorderStyle="None"></asp:TextBox>
					</td>
				</tr>
				<tr>
					<td style="width: 200px">
