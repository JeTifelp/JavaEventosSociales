...
namespace studio.ClassicSample.StaticBindings
{
	...
	{
		public static List<BOPersona> GetPersonaList()
		{
			try
			{
				List<BOPersona> listPersona = BOPersona.PersonaCollection();
				return listPersona;
			}
			catch(Exception)
			{	/*rethrow or handle gracefully*/return new List<BOPersona>();	}
			finally	{	}
		}
	}
}
