...
namespace studio.ClassicSample.StaticBindings
{
	...
	{
		public static List<BODirecciones> GetDireccionesList()
		{
			try
			{
				List<BODirecciones> listDirecciones = BODirecciones.DireccionesCollection();
				return listDirecciones;
			}
			catch(Exception)
			{	/*rethrow or handle gracefully*/return new List<BODirecciones>();	}
			finally	{	}
		}
	}
}
