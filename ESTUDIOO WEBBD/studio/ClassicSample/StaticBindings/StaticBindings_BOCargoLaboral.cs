...
namespace studio.ClassicSample.StaticBindings
{
	...
	{
		public static List<BOCargoLaboral> GetCargoLaboralList()
		{
			try
			{
				List<BOCargoLaboral> listCargoLaboral = BOCargoLaboral.CargoLaboralCollection();
				return listCargoLaboral;
			}
			catch(Exception)
			{	/*rethrow or handle gracefully*/return new List<BOCargoLaboral>();	}
			finally	{	}
		}
	}
}
