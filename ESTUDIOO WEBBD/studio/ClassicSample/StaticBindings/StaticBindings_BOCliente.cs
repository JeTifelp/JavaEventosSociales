...
namespace studio.ClassicSample.StaticBindings
{
	...
	{
		public static List<BOCliente> GetClienteList()
		{
			try
			{
				List<BOCliente> listCliente = BOCliente.ClienteCollection();
				return listCliente;
			}
			catch(Exception)
			{	/*rethrow or handle gracefully*/return new List<BOCliente>();	}
			finally	{	}
		}
	}
}
