...
namespace studio.ClassicSample.StaticBindings
{
	...
	{
		public static List<BOContrato> GetContratoList()
		{
			try
			{
				List<BOContrato> listContrato = BOContrato.ContratoCollection();
				return listContrato;
			}
			catch(Exception)
			{	/*rethrow or handle gracefully*/return new List<BOContrato>();	}
			finally	{	}
		}
	}
}
