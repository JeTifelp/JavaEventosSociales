...
namespace studio.ClassicSample.StaticBindings
{
	...
	{
		public static List<BOEmpleado> GetEmpleadoList()
		{
			try
			{
				List<BOEmpleado> listEmpleado = BOEmpleado.EmpleadoCollection();
				return listEmpleado;
			}
			catch(Exception)
			{	/*rethrow or handle gracefully*/return new List<BOEmpleado>();	}
			finally	{	}
		}
	}
}
