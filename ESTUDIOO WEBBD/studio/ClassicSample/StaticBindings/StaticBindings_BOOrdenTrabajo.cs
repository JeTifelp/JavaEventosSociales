...
namespace studio.ClassicSample.StaticBindings
{
	...
	{
		public static List<BOOrdenTrabajo> GetOrdenTrabajoList()
		{
			try
			{
				List<BOOrdenTrabajo> listOrdenTrabajo = BOOrdenTrabajo.OrdenTrabajoCollection();
				return listOrdenTrabajo;
			}
			catch(Exception)
			{	/*rethrow or handle gracefully*/return new List<BOOrdenTrabajo>();	}
			finally	{	}
		}
	}
}
