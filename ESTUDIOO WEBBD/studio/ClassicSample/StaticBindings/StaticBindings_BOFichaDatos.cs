...
namespace studio.ClassicSample.StaticBindings
{
	...
	{
		public static List<BOFichaDatos> GetFichaDatosList()
		{
			try
			{
				List<BOFichaDatos> listFichaDatos = BOFichaDatos.FichaDatosCollection();
				return listFichaDatos;
			}
			catch(Exception)
			{	/*rethrow or handle gracefully*/return new List<BOFichaDatos>();	}
			finally	{	}
		}
	}
}
