...
namespace studio.ClassicSample.StaticBindings
{
	...
	{
		public static List<BOTipoEvento> GetTipoEventoList()
		{
			try
			{
				List<BOTipoEvento> listTipoEvento = BOTipoEvento.TipoEventoCollection();
				return listTipoEvento;
			}
			catch(Exception)
			{	/*rethrow or handle gracefully*/return new List<BOTipoEvento>();	}
			finally	{	}
		}
	}
}
