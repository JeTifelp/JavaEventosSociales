...
namespace studio.ClassicSample.StaticBindings
{
	...
	{
		public static List<BOReserva> GetReservaList()
		{
			try
			{
				List<BOReserva> listReserva = BOReserva.ReservaCollection();
				return listReserva;
			}
			catch(Exception)
			{	/*rethrow or handle gracefully*/return new List<BOReserva>();	}
			finally	{	}
		}
	}
}
