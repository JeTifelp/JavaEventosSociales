...
namespace studio.ClassicSample.StaticBindings
{
	...
	{
		public static List<BOPaquete> GetPaqueteList()
		{
			try
			{
				List<BOPaquete> listPaquete = BOPaquete.PaqueteCollection();
				return listPaquete;
			}
			catch(Exception)
			{	/*rethrow or handle gracefully*/return new List<BOPaquete>();	}
			finally	{	}
		}
	}
}
