...
namespace studio.ClassicSample.StaticBindings
{
	...
	{
		public static List<BOUtilizaEE> GetUtilizaEEList()
		{
			try
			{
				List<BOUtilizaEE> listUtilizaEE = BOUtilizaEE.UtilizaEECollection();
				return listUtilizaEE;
			}
			catch(Exception)
			{	/*rethrow or handle gracefully*/return new List<BOUtilizaEE>();	}
			finally	{	}
		}
	}
}
