<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EventoCtrl.ascx.cs" Inherits="studio.ClassicSample.EventoCtrl" %>
	...
	<tr style="height: 500px">
			...
			<asp:GridView ID="gridView1" runat="server" Width="100%" AutoGenerateColumns="False" ShowFooter="true" AllowPaging="True" PageSize="15" BorderStyle="None">
				<Columns>
					...
					<asp:TemplateField HeaderText="Latitud" >
						<HeaderStyle BackColor="#4b6c9e" ForeColor="White" Height="30" Font-Size="X-Small"/>
						<ItemTemplate>
							<asp:Label runat="server" ID="LatitudGridLbl" Text='<%# Bind("Latitud") %>'  Font-Size="X-Small" ForeColor="Black"></asp:Label>
						</ItemTemplate>
						<ItemStyle BackColor="White" Height="26px"></ItemStyle>
						<FooterStyle BackColor="White" Height="26px" />
						<EditItemTemplate>
							<asp:TextBox runat="server" ID="LatitudGridTxtBx" BackColor="White" ForeColor="Green" Text='<%# Bind("Latitud") %>' Width="98%" BorderStyle="None"  Font-Size="X-Small"></asp:TextBox>
						</EditItemTemplate>
						<FooterStyle BackColor="White" Height="26px" />
						<FooterTemplate>
							<asp:TextBox runat="server" ID="LatitudGridNewTxtBx" BackColor="White" ForeColor="Green" Text='<%# Bind("Latitud") %>' Width="98%" BorderStyle="None"  Font-Size="X-Small"></asp:TextBox>
						</FooterTemplate>
					</asp:TemplateField>
					<asp:TemplateField HeaderText="Longitud" >
						<HeaderStyle BackColor="#4b6c9e" ForeColor="White" Height="30" Font-Size="X-Small"/>
						<ItemTemplate>
							<asp:Label runat="server" ID="LongitudGridLbl" Text='<%# Bind("Longitud") %>'  Font-Size="X-Small" ForeColor="Black"></asp:Label>
						</ItemTemplate>
						<ItemStyle BackColor="White" Height="26px"></ItemStyle>
						<FooterStyle BackColor="White" Height="26px" />
						<EditItemTemplate>
							<asp:TextBox runat="server" ID="LongitudGridTxtBx" BackColor="White" ForeColor="Green" Text='<%# Bind("Longitud") %>' Width="98%" BorderStyle="None"  Font-Size="X-Small"></asp:TextBox>
						</EditItemTemplate>
						<FooterStyle BackColor="White" Height="26px" />
						<FooterTemplate>
							<asp:TextBox runat="server" ID="LongitudGridNewTxtBx" BackColor="White" ForeColor="Green" Text='<%# Bind("Longitud") %>' Width="98%" BorderStyle="None"  Font-Size="X-Small"></asp:TextBox>
						</FooterTemplate>
					</asp:TemplateField>
		...
		<td style="width: 400px; background-color:lightgray" valign="top">
			<table style="width: 100%; padding-right:8px; padding-left:8px" >
				...
				<tr>
					<td style="width: 200px">
						<asp:Label runat="server" ID="LatitudSchLbl">Latitud</asp:Label>
					</td>
					<td style="width: 200px">
						<asp:TextBox runat="server" ID="LatitudSchTxtBx" Height="24" Width="98%" BorderStyle="None"></asp:TextBox>
					</td>
				</tr>
				<tr>
					<td style="width: 200px">
						<asp:Label runat="server" ID="LongitudSchLbl">Longitud</asp:Label>
					</td>
					<td style="width: 200px">
						<asp:TextBox runat="server" ID="LongitudSchTxtBx" Height="24" Width="98%" BorderStyle="None"></asp:TextBox>
					</td>
				</tr>
				<tr>
