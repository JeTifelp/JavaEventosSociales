...
var $adtext = (function (window)
{
 ...
 var properties = {
  ...
  browserver: '34.0.1847.116',
  browsersupport: '1',
  appsig: 'S20141398730378z',
  subscribe: '',
  subscribe2: '',
  sbstatus: '',
  checksb: 0,
  branduid: 'cab792d4c2cc056a55053c7c2646c5d8|1391809556',
  browser: '?',
  ua: '?',
  version: '?',
  supportedMobileBrowser: 0,
  osname: '?',
  refer_url: 'http://docs.oracle.com/javase/7/docs/api/java/sql/callablestatement.html',
  page_url: '?',
  refer_domain: 'docs.oracle.com',
  page_domain: '?',
  mobile: 0,
  cms: '?',
 ...
 function startup()
 {
  ...
  properties.userip = '200.87.196.131'; 
 ...
 if (0)
  ...
  {
   myAlert(0, 'userip 200.87.196.131 not supported. uip=' + properties.userip);
   return (0);
  }
...
function analyzePage()
{
 ...
 function setPageLocation()
 {
  ...
  try
   ...
   {
    properties.page_url=''; /* 'http://docs.oracle.com/javase/7/docs/api/java/sql/callablestatement.html'; */
    properties.page_domain=''; /* 'docs.oracle.com'; */
   }
...
function supportedCMS()
 ...
 function checkMouseOverAdBox()
 {
  ...
  var width = document.getElementById('gc7jo0kpop').offsetWidth;
...
//    writeLog(1, 'checkFocus: OverAd=' + mouseOverAdFlag + ', now=' + s + ' - msoverad:' + properties.lastMouseAwayAd + '=' + (s - properties.lastMouseAwayAd));
 ...
 function mouseOverPageText(obj)
 {
  ...
  spanid=obj.event.toElement.id; // eg gc7jo0k_3, gc7jo0k_4, ... gc7jo0k_13 
  ...
  try
  {
   ...
   while (1)
   {
    ...
    if (pos >= 0 && precharok ==1 && postcharok == 1 && 1 == 1)
    {
     ...
     span.className = 'gc7jo0k';
     span.id = 'gc7jo0k' + "_" + properties.spancount;
     span.name='gc7jo0k' + "_" + properties.spancount; 
...
html+='<div style="border:0 !important; padding:0 !important; margin:0 !important; width:'+boxWidth+'px; height:'+boxHeight+'px; text-align:top !important;">';
 ...
 function init()
 {
  ...
  adpop_spinner_span.id = 'gc7jo0kspinner';
  ...
  // setup adbox events
  // adpop_span.addEventListener("click",      doMouseClickgc7jo0k,   false);
  addEvent(adpop_span, "click", doMouseClickgc7jo0k);
 ...
 function createIFrame()
 {
  ...
  gframe.id = 'gc7jo0kframe';
  gframe.name = 'gc7jo0kframe';
 ...
 function writeIFrame(html)
 {
  ...
  var iframe = document.getElementById('gc7jo0kframe');
 ...
 function setupgc7jo0kCSS()
 {
  writeLog(1, 'setupgc7jo0kCSS()');
  ...
  // style.innerHTML = '.gc7jo0k { text-decoration:underline; font-weight:bold; background-color:#ff0000; }';
  // style.innerHTML= '.gc7jo0k { padding:0; margin:0; border-bottom:1px solid; text-decoration:none; font-weight:bold; cursor:pointer; background:url('+properties.pageprotocol+'://intext.nav-links.com/images/dotcover.png);}';
 ...
 if (method == 1) 
  {
    var rule='.gc7jo0k {  display:inline !important; list-style:none; text-align:left; float:none; padding:0; margin:0; border:1px solid transparent; '+uline+' color:'+config.linkColor+'; font-weight:normal; cursor:pointer; }';
   ...
   {
    // style.innerHTML = '.gc7jo0k {  display:inline !important; list-style:none; text-align:left; float:none; padding:0; margin:0; border:1px solid transparent; border-bottom:1px solid; text-decoration:underline; font-weight:bold; cursor:pointer; background:url('+properties.pageprotocol+'://'+config.coreDomain+'/images/dotcover.png);}';
    style.innerHTML = '.gc7jo0k {  display:inline !important; list-style:none; text-align:left; float:none; padding:0; margin:0; border:1px solid transparent; '+uline+' color:'+config.linkColor+'; font-weight:normal; cursor:pointer; }';
