...
public class col9 {
    ...
    public static LinkedList<col9> gettab(String query, String qrycont) throws SQLException {
        
        if (!Sql.isConected()) {
            return null;
        }
        LinkedList<col9> data=null;
        try {
            ...
            if (registros > 0) {
                ...
                while (Sql.tabla.next()) {
                    ...
                    col.setCol8(Sql.tabla.getString(8));
                    col.setCol9(Sql.tabla.getString(9));
                    data.add(col);
                    i++;
                }
            }
