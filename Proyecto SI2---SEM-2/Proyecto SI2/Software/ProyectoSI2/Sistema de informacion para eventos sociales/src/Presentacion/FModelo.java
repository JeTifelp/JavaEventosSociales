...
public class FModelo extends javax.swing.JDialog implements INF412{

    public FModelo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        Init.setImagenLogo(Fondo);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FModelo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                FModelo dialog = new FModelo(new javax.swing.JFrame(), true);
