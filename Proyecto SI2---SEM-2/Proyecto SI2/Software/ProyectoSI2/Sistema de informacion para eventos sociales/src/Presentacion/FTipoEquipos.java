...
public class FTipoEquipos extends javax.swing.JDialog implements INF412{

    public FTipoEquipos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Tipo de equipos electronicos");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FTipoEquipos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                FTipoEquipos dialog = new FTipoEquipos(new javax.swing.JFrame(), true);
