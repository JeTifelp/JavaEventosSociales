...
public class FEventualidadesProximas extends javax.swing.JDialog implements INF412{

    public FEventualidadesProximas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Eventualidades Proximas");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FEventualidadesProximas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                FEventualidadesProximas dialog = new FEventualidadesProximas(new javax.swing.JFrame(), true);
