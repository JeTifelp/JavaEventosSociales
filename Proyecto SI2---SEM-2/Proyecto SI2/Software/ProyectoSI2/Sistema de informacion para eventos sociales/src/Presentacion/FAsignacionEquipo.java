...
public class FAsignacionEquipo extends javax.swing.JDialog implements INF412{

    public FAsignacionEquipo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Asignacion de equipos para los eventos");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FAsignacionEquipo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                FAsignacionEquipo dialog = new FAsignacionEquipo(new javax.swing.JFrame(), true);
